<script src="https://cdn02.jotfor.ms/static/prototype.forms.js?3.3.34181" type="text/javascript"></script>
<script src="https://cdn03.jotfor.ms/static/jotform.forms.js?3.3.34181" type="text/javascript"></script>
<script src="https://cdn01.jotfor.ms/js/vendor/imageinfo.js?v=3.3.34181" type="text/javascript"></script>
<script src="https://cdn02.jotfor.ms/file-uploader/fileuploader.js?v=3.3.34181"></script>
...
if (window.JotForm && JotForm.accessible) $('input_18').setAttribute('tabindex',0);
   ...
   JotForm.prepareCalculationsOnTheFly([null,null,null,null,null,null,null,null,null,null,null,{"name":"addbook","qid":"11","text":"Add Book","type":"control_button"},null,{"name":"clickTo","qid":"13","text":"Add A New Book","type":"control_head"},{"description":"","name":"bookCode","qid":"14","subLabel":"Enter 4 Digit Book Code","text":"Book Code","type":"control_number"},null,{"description":"","name":"uploadPdf","qid":"16","subLabel":"","text":"Upload Pdf File","type":"control_fileupload"},null,{"description":"","name":"bookName","qid":"18","subLabel":"Enter Book Name","text":"Book Name","type":"control_textbox"},{"description":"","name":"authorName","qid":"19","text":"Author Name","type":"control_fullname"},{"description":"","name":"name20","qid":"20","text":"Publisher Name","type":"control_fullname"},null,null,null,{"description":"","name":"bookType","qid":"24","text":"Book Type","type":"control_radio"},null,null,null,null,null,null,null,{"description":"","name":"typeA","qid":"32","subLabel":"","text":"Book Categories","type":"control_dropdown"}]);
   setTimeout(function() {
JotForm.paymentExtrasOnTheFly([null,null,null,null,null,null,null,null,null,null,null,{"name":"addbook","qid":"11","text":"Add Book","type":"control_button"},null,{"name":"clickTo","qid":"13","text":"Add A New Book","type":"control_head"},{"description":"","name":"bookCode","qid":"14","subLabel":"Enter 4 Digit Book Code","text":"Book Code","type":"control_number"},null,{"description":"","name":"uploadPdf","qid":"16","subLabel":"","text":"Upload Pdf File","type":"control_fileupload"},null,{"description":"","name":"bookName","qid":"18","subLabel":"Enter Book Name","text":"Book Name","type":"control_textbox"},{"description":"","name":"authorName","qid":"19","text":"Author Name","type":"control_fullname"},{"description":"","name":"name20","qid":"20","text":"Publisher Name","type":"control_fullname"},null,null,null,{"description":"","name":"bookType","qid":"24","text":"Book Type","type":"control_radio"},null,null,null,null,null,null,null,{"description":"","name":"typeA","qid":"32","subLabel":"","text":"Book Categories","type":"control_dropdown"}]);}, 20); 
</script>
...
<link type="text/css" rel="stylesheet" href="https://cdn02.jotfor.ms/themes/CSS/548a097b700cc4dd218b4567.css?themeRevisionID=5fbe933a1b9daf23d8388ca1"/>
<link type="text/css" rel="stylesheet" href="https://cdn03.jotfor.ms/css/styles/payment/payment_styles.css?3.3.34181" />
<link type="text/css" rel="stylesheet" href="https://cdn01.jotfor.ms/css/styles/payment/payment_feature.css?3.3.34181" />
...
<form class="jotform-form" action="https://submit.jotform.com/submit/221645765808465/" method="post" enctype="multipart/form-data" name="form_221645765808465" id="221645765808465" accept-charset="utf-8" autocomplete="on">
  <input type="hidden" name="formID" value="221645765808465" />
    ...
    <ul class="form-section page-section">
      ...
      <li class="form-line jf-required" data-type="control_number" id="id_14">
        ...
        <div id="cid_14" class="form-input-wide jf-required" data-layout="half">
          <span class="form-sub-label-container" style="vertical-align:top">
            <input type="number" id="input_14" name="q14_bookCode" data-type="input-number" class=" form-number-input form-textbox validate[required]" data-defaultvalue="" style="width:310px" size="310" value="" placeholder="Enter Book Id" data-component="number" aria-labelledby="label_14 sublabel_input_14" required="" step="any" />
            <label class="form-sub-label" for="input_14" id="sublabel_input_14" style="min-height:13px" aria-hidden="false"> Enter 4 Digit Book Code </label>
          </span>
        </div>
      </li>
      <li class="form-line jf-required" data-type="control_textbox" id="id_18">
        ...
        <div id="cid_18" class="form-input-wide jf-required" data-layout="half">
          <span class="form-sub-label-container" style="vertical-align:top">
            <input type="text" id="input_18" name="q18_bookName" data-type="input-textbox" class="form-textbox validate[required]" data-defaultvalue="" style="width:310px" size="310" value="" data-component="textbox" aria-labelledby="label_18 sublabel_input_18" required="" />
            <label class="form-sub-label" for="input_18" id="sublabel_input_18" style="min-height:13px" aria-hidden="false"> Enter Book Name </label>
          </span>
        </div>
      </li>
        ...
        <div id="cid_19" class="form-input-wide jf-required" data-layout="full">
          <div data-wrapper-react="true">
            <span class="form-sub-label-container" style="vertical-align:top" data-input-type="first">
              <input type="text" id="first_19" name="q19_authorName[first]" class="form-textbox validate[required]" data-defaultvalue="" autoComplete="section-input_19 given-name" size="10" value="" data-component="first" aria-labelledby="label_19 sublabel_19_first" required="" />
            ...
            <span class="form-sub-label-container" style="vertical-align:top" data-input-type="last">
              <input type="text" id="last_19" name="q19_authorName[last]" class="form-textbox validate[required]" data-defaultvalue="" autoComplete="section-input_19 family-name" size="15" value="" data-component="last" aria-labelledby="label_19 sublabel_19_last" required="" />
      ...
      <li class="form-line jf-required" data-type="control_fullname" id="id_20">
        ...
        <div id="cid_20" class="form-input-wide jf-required" data-layout="full">
          <div data-wrapper-react="true">
            <span class="form-sub-label-container" style="vertical-align:top" data-input-type="first">
              <input type="text" id="first_20" name="q20_name20[first]" class="form-textbox validate[required]" data-defaultvalue="" autoComplete="section-input_20 given-name" size="10" value="" data-component="first" aria-labelledby="label_20 sublabel_20_first" required="" />
              <label class="form-sub-label" for="first_20" id="sublabel_20_first" style="min-height:13px" aria-hidden="false"> First Name </label>
            </span>
            <span class="form-sub-label-container" style="vertical-align:top" data-input-type="last">
              <input type="text" id="last_20" name="q20_name20[last]" class="form-textbox validate[required]" data-defaultvalue="" autoComplete="section-input_20 family-name" size="15" value="" data-component="last" aria-labelledby="label_20 sublabel_20_last" required="" />
              <label class="form-sub-label" for="last_20" id="sublabel_20_last" style="min-height:13px" aria-hidden="false"> Last Name </label>
            </span>
          </div>
        </div>
      </li>
      <li class="form-line jf-required" data-type="control_dropdown" id="id_32">
        ...
        <div id="cid_32" class="form-input-wide jf-required" data-layout="half">
          <select class="form-dropdown validate[required]" id="input_32" name="q32_typeA" style="width:310px" data-component="dropdown" required="">
        ...
        <div id="cid_24" class="form-input-wide jf-required" data-layout="full">
          <div class="form-single-column" role="group" aria-labelledby="label_24" data-component="radio">
            <span class="form-radio-item" style="clear:left">
              ...
              <input type="radio" aria-describedby="label_24" class="form-radio validate[required]" id="input_24_0" name="q24_bookType" value="Free Book" required="" />
              <label id="label_input_24_0" for="input_24_0"> Free Book </label>
            </span>
            <span class="form-radio-item" style="clear:left">
              <span class="dragger-item">
              </span>
              <input type="radio" aria-describedby="label_24" class="form-radio validate[required]" id="input_24_1" name="q24_bookType" value="Paid Book" required="" />
              <label id="label_input_24_1" for="input_24_1"> Paid Book </label>
            </span>
          </div>
        </div>
      </li>
            ...
            <div class="jfField isFilled">
              <div class="jfUpload-wrapper">
                ...
                <div class="jfUpload-files-container">
                  <input type="file" id="input_16" name="q16_uploadPdf[]" multiple="" class="form-upload-multiple validate[required]" data-imagevalidate="yes" data-file-accept="pdf, doc, docx, xls, xlsx, csv, txt, rtf, html, zip, mp3, wma, mpg, flv, avi, jpg, jpeg, png, gif" data-file-maxsize="10854" data-file-minsize="0" data-file-limit="" data-component="fileupload" required="" aria-label="Browse Files" />
                </div>
              </div>
              <div data-wrapper-react="true">
              </div>
      ...
      <li class="form-line" data-type="control_button" id="id_11">
        <div id="cid_11" class="form-input-wide" data-layout="full">
          <div data-align="auto" class="form-buttons-wrapper form-buttons-auto   jsTest-button-wrapperField">
            <button id="input_11" type="submit" class="form-submit-button form-submit-button-denim_dark_blue submit-button jf-form-buttons jsTest-submitField" data-component="button" data-content="">
              Add Book
            </button>
          </div>
        </div>
  ...
  <input type="hidden" class="simple_spc" id="simple_spc" name="simple_spc" value="221645765808465" />
  <script type="text/javascript">
  var all_spc = document.querySelectorAll("form[id='221645765808465'] .si" + "mple" + "_spc");
for (var i = 0; i < all_spc.length; i++)
{
  ...
  <div class="formFooter f6 branding21">
    <div class="formFooter-wrapper formFooter-leftSide">
      <a href="https://www.jotform.com/?utm_source=formfooter&utm_medium=banner&utm_term=221645765808465&utm_content=jotform_logo&utm_campaign=powered_by_jotform_le" target="_blank" class="formFooter-logoLink"><img class="formFooter-logo" src="https://cdn.jotfor.ms/assets/img/logo2021/jotform-logo-white.svg" alt="Jotform Logo" style="height: 44px;"></a>
    </div>
    <div class="formFooter-wrapper formFooter-rightSide">
      <span class="formFooter-text">
        Now create your own Jotform - It's free!
      </span>
      <a class="formFooter-button" href="https://www.jotform.com/?utm_source=formfooter&utm_medium=banner&utm_term=221645765808465&utm_content=jotform_button&utm_campaign=powered_by_jotform_le" target="_blank">Create your own Jotform</a>
    </div>
  </div>
</form>
<script src="https://cdn.jotfor.ms//js/vendor/smoothscroll.min.js?v=3.3.34181"></script>
<script src="https://cdn.jotfor.ms//js/errorNavigation.js?v=3.3.34181"></script>